...
void Fig4() {	
	...
	TFile f("OutputRoot_Test_Baseline_6Y.root","read");
	...
	TFile f2("PDFs_NuSol_J21v1r0-Pre0_r15_Thr300_1Y_Smoothed_2021-June_N13O15.root","read");
	...
	/**** TOTAL FIT ****/
	//htotal->SetLineColor(kMagenta); htotal->SetLineWidth(3); 
	//htotal->DrawCopy("same");
	//h1->DrawCopy("P0same");
...
//	h4->SetLineColor(618); h4->SetLineWidth(3);
//	h4->DrawCopy("same");
